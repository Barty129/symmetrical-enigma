...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    $date_proj_r = mysqli_real_escape_string($conn, $_POST['date_r']);
    $name_r = mysqli_real_escape_string($conn, $_POST['Name_r']);
    $ids_r = mysqli_real_escape_string($conn, $_POST['_ID_r']);
    $pr_project = mysqli_real_escape_string($conn, $_POST['rela_project']);
    $person_1 = mysqli_real_escape_string($conn, $_POST['Personnel_1']);

    $essential1_r = mysqli_real_escape_string($conn, $_POST['essential1']);
    $essential2_r = mysqli_real_escape_string($conn, $_POST['essential2']);
    $essential3_r = mysqli_real_escape_string($conn, $_POST['essential3']);

    $desirable1_r = mysqli_real_escape_string($conn, $_POST['desirable1']);
    $desirable2_r = mysqli_real_escape_string($conn, $_POST['desirable2']);
    $desirable3_r = mysqli_real_escape_string($conn, $_POST['desirable3']);

    $preferable1_r = mysqli_real_escape_string($conn, $_POST['preferable1']);
    $preferable2_r = mysqli_real_escape_string($conn, $_POST['preferable2']);
    $preferable3_r = mysqli_real_escape_string($conn, $_POST['preferable3']);

    $sysi1_r = mysqli_real_escape_string($conn, $_POST['sysi1']);
    $sysi2_r = mysqli_real_escape_string($conn, $_POST['sysi2']);
    $sysi3_r = mysqli_real_escape_string($conn, $_POST['sysi3']);

    $perfval1_r = mysqli_real_escape_string($conn, $_POST['perfval1']);
    $perfval2_r = mysqli_real_escape_string($conn, $_POST['perfval2']);
    $perfval3_r = mysqli_real_escape_string($conn, $_POST['perfval3']);

    $intpro1_r = mysqli_real_escape_string($conn, $_POST['intpro1']);
    $intpro2_r = mysqli_real_escape_string($conn, $_POST['intpro2']);
    $intpro3_r = mysqli_real_escape_string($conn, $_POST['intpro3']);

    $failerror1_r = mysqli_real_escape_string($conn, $_POST['failerrorhandle1']);
    $failerror2_r = mysqli_real_escape_string($conn, $_POST['failerrorhandle2']);
    $failerror3_r = mysqli_real_escape_string($conn, $_POST['failerrorhandle3']);

    $designdocu1_r = mysqli_real_escape_string($conn, $_POST['designdocu1']);
    $designdocu2_r = mysqli_real_escape_string($conn, $_POST['designdocu2']);
    $designdocu3_r = mysqli_real_escape_string($conn, $_POST['designdocu3']);

    $funcdocu1_r = mysqli_real_escape_string($conn, $_POST['funcdocu1']);
    $funcdocu2_r = mysqli_real_escape_string($conn, $_POST['funcdocu2']);
    $funcdocu3_r = mysqli_real_escape_string($conn, $_POST['funcdocu3']);

    $opspro1_r = mysqli_real_escape_string($conn, $_POST['opspro1']);
    $opspro2_r = mysqli_real_escape_string($conn, $_POST['opspro2']);
    $opspro3_r = mysqli_real_escape_string($conn, $_POST['opspro3']);
    ...
    //It's just long, no match for my sexy table joins in the expenses system - TC
